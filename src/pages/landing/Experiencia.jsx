const Experiencia = () => {
  return (
    <div className="md:flex items-center">
      <div className="items-center min-h-full md:w1/2 lg:w-full text-center p-10 bg-[#D9D9D9] shadow-md shadow-black grid justify-items-stretch grid-cols-2">
        <div className="experiencia rounded-lg m-2 shadow-md shadow-black bg-[#1F2431] p-10 h-auto text-center ">
          ...
          <a href="https://storied-dasik-44ad01.netlify.app/">
            <button
              type="button"
              className="text-black bg-[#D9D9D9] hover:bg-[#24292F]/90 hover:text-white focus:ring-4  font-bold rounded-lg  px-5 py-2.5 text-center inline-flex items-center mr-2 mt-4"
            >
              <svg
          ...
          <a href="https://github.com/lberqui/todolist">
          <button
            type="button"
            className="text-black bg-[#D9D9D9] hover:bg-[#24292F]/90 hover:text-white focus:ring-4  font-bold rounded-lg  px-5 py-2.5 text-center inline-flex items-center mr-2 mt-4"
          >
        ...
        <div className="experiencia rounded-lg m-2 shadow-md shadow-black bg-[#1F2431] p-10 h-auto text-center">
          ...
          <a href="https://frabjous-tanuki-68f162.netlify.app/">
          <button
            type="button"
            className="text-black bg-[#D9D9D9] hover:bg-[#24292F]/90 hover:text-white focus:ring-4  font-bold rounded-lg  px-5 py-2.5 text-center inline-flex items-center mr-2 mt-4"
          >
          ...
          <a href="https://github.com/lberqui/API-HEROES">
          <button
            type="button"
            className="text-black bg-[#D9D9D9] hover:bg-[#24292F]/90 hover:text-white focus:ring-4  font-bold rounded-lg  px-5 py-2.5 text-center inline-flex items-center"
          >
            <svg
              class="mr-2 -ml-1 w-4 h-4"
              aria-hidden="true"
        ...
        <div className="experiencia rounded-lg m-2 shadow-md shadow-black bg-[#1F2431] p-10 h-auto text-center">
          ...
          <a href="https://github.com/lberqui/API_CLIMA">
          <button
            type="button"
            className="text-black bg-[#D9D9D9] hover:bg-[#24292F]/90 hover:text-white focus:ring-4  font-bold rounded-lg  px-5 py-2.5 text-center inline-flex items-center"
          >
